        ...
        <div className="flex">
          ...
          {[...Array(isMobile ? 3 : 10)].map((_, i) => (
            <div key={i} className="relative h-screen w-screen">
              <img
                src={isMobile 
                  ? "https://pub-1c024d6181db4a8d9ce127046cdbc59f.r2.dev/Instagram%20bg.png" // Use smaller image for mobile
                  : "https://pub-1c024d6181db4a8d9ce127046cdbc59f.r2.dev/Instagram%20bg.png"
                }
                alt=""

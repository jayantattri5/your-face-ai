    ...
    <div className="relative w-full h-screen bg-black text-white overflow-hidden">
        ...
        <div className="flex">
          ...
          {[...Array(isMobile ? 3 : 10)].map((_, i) => (
            <div key={i} className="relative h-screen w-screen">
              <img
                src={isMobile 
                  ? "https://pub-1c024d6181db4a8d9ce127046cdbc59f.r2.dev/Boudoir%20bg.png" // Use smaller image for mobile
                  : "https://pub-1c024d6181db4a8d9ce127046cdbc59f.r2.dev/Boudoir%20bg.png"
                }
                alt=""
      ...
      <div className={`absolute top-0 left-0 w-full h-full 
        ${isMobile 
          ...
          : 'bg-gradient-to-b from-black/30 via-black/50 to-black/30'
        } z-5`}></div>

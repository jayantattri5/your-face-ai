...
const PackCardCarousel = () => {
  ...
  const packs = [
    ...
    },
    {
      ...
      {
        id: 9,
        title: "🦅 Turn yourself into a Sigma",
        description: "Turn yourself into a Sigma male—a man who walks his own path, unfazed by societal expectations or the need for validation. Unlike the Alpha, who thrives on dominance, or the Beta, who seeks approval, the Sigma exists outside the hierarchy, moving in silence and letting his actions speak for themselves.The Sigma male understands the game but refuses to play it on anyone’s terms but his own. He builds his wealth, hones his skills, and remains emotionally untouchable.",
        photoCount: "30 PHOTOS",
        ranCount: "49X RAN THIS WEEK",
        color: "#3399ff",
        images: ["https://pub-1c024d6181db4a8d9ce127046cdbc59f.r2.dev/487264977_18488412118065620_843272200611070313_n.jpeg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfvDb5XLv1aI4RCWbKrd7gW83yGIwHwp_vZQ&s"]
      },
      {
        id: 10,
